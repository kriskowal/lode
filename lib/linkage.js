...
function configure(config, pkg, options) {
    ...
    if (Array.isArray(dependencies)) {
        config.narwhal = true;
        throw new Error("Narwhal packages are not supported " + JSON.stringify(options.href));
    } else if (isObject(dependencies)) {
        // support NPM-specific dependencies
